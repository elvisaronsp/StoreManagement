    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your FruitCorrect Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to FruitCorrect Web";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your FruitCorrect Account";
                    ...
                    public static LocalText FormTitle = "Sign up for FruitCorrect";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "FruitCorrect";
        }
