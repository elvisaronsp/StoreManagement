...
(function (FruitCorrect) {
    ...
    })(BasicSamples = FruitCorrect.BasicSamples || (FruitCorrect.BasicSamples = {}));
})(FruitCorrect || (FruitCorrect = {}));
var FruitCorrect;
(function (FruitCorrect) {
    var BasicSamples;
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return FruitCorrect.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = FruitCorrect.BasicSamples || (FruitCorrect.BasicSamples = {}));
})(FruitCorrect || (FruitCorrect = {}));
var FruitCorrect;
(function (FruitCorrect) {
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return FruitCorrect.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return FruitCorrect.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = FruitCorrect.BasicSamples || (FruitCorrect.BasicSamples = {}));
})(FruitCorrect || (FruitCorrect = {}));
var FruitCorrect;
(function (FruitCorrect) {
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return FruitCorrect.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return FruitCorrect.StaticTextBlock; }], ['FromLocalText', function () { return FruitCorrect.StaticTextBlock; }], ['DisplayFieldValue', function () { return FruitCorrect.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = FruitCorrect.BasicSamples || (FruitCorrect.BasicSamples = {}));
})(FruitCorrect || (FruitCorrect = {}));
var FruitCorrect;
(function (FruitCorrect) {
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        ...
        }(FruitCorrect.Northwind.ProductDialog));
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        ...
        }(FruitCorrect.Northwind.ProductGrid));
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: FruitCorrect.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: FruitCorrect.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new FruitCorrect.Northwind.OrderDialog();
                        ...
                        var chai = FruitCorrect.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = FruitCorrect.Northwind.EmployeeRow.getLookup().items
        ...
        }(FruitCorrect.Northwind.OrderGrid));
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        ...
        }(FruitCorrect.Northwind.OrderDialog));
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew) {
                    ...
                    FruitCorrect.Northwind.CategoryService.Retrieve({
        ...
        }(FruitCorrect.Northwind.CategoryDialog));
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        ...
        }(FruitCorrect.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    items: Q.getForm(FruitCorrect.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new FruitCorrect.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                FruitCorrect.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(FruitCorrect.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    FruitCorrect.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(FruitCorrect.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(FruitCorrect.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    FruitCorrect.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return FruitCorrect.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return FruitCorrect.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return FruitCorrect.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return FruitCorrect.Northwind.OrderService.baseUrl; };
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        ...
        }(FruitCorrect.Northwind.SupplierDialog));
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = (function (_super) {
            ...
            return ReadOnlyGrid;
        }(FruitCorrect.Northwind.SupplierGrid));
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return FruitCorrect.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return FruitCorrect.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return FruitCorrect.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return FruitCorrect.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return FruitCorrect.Northwind.OrderService.baseUrl; };
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    FruitCorrect.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(FruitCorrect.Northwind.CustomerDialog));
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        ...
        }(FruitCorrect.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = FruitCorrect.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return FruitCorrect.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return FruitCorrect.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new FruitCorrect.Northwind.OrderDetailForm(_this.idPrefix);
                ...
                _this.form.ProductID.cascadeField = FruitCorrect.Northwind.ProductRow.Fields.CategoryID;
                return _this;
        ...
        }(FruitCorrect.Northwind.OrderDetailDialog));
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        ...
        }(FruitCorrect.Northwind.OrderDetailsEditor));
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return FruitCorrect.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return FruitCorrect.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return FruitCorrect.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return FruitCorrect.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return FruitCorrect.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (FruitCorrect) {
    ...
    FruitCorrect.StaticTextBlock = StaticTextBlock;
})(FruitCorrect || (FruitCorrect = {}));
var FruitCorrect;
(function (FruitCorrect) {
    var BasicSamples;
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        ...
        }(FruitCorrect.Common.BulkServiceAction));
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return FruitCorrect.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return FruitCorrect.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return FruitCorrect.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return FruitCorrect.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = FruitCorrect.Northwind.ProductRow.Fields;
    ...
    (function (BasicSamples) {
        var CustomLinksInGrid = (function (_super) {
            ...
            CustomLinksInGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = FruitCorrect.Northwind.OrderRow.Fields;
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(FruitCorrect.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new FruitCorrect.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new FruitCorrect.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new FruitCorrect.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, FruitCorrect.Northwind.OrderRow.Fields.ShipCountry);
...
(function (FruitCorrect) {
    ...
    FruitCorrect.SelectableEntityGrid = SelectableEntityGrid;
})(FruitCorrect || (FruitCorrect = {}));
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return FruitCorrect.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return FruitCorrect.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return FruitCorrect.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return FruitCorrect.Northwind.SupplierService.baseUrl; };
            return RowSelectionGrid;
        }(FruitCorrect.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = FruitCorrect.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            FruitCorrect.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return FruitCorrect.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return FruitCorrect.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return FruitCorrect.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return FruitCorrect.Northwind.ProductService.baseUrl; };
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return FruitCorrect.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return FruitCorrect.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return FruitCorrect.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return FruitCorrect.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return FruitCorrect.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return FruitCorrect.Northwind.CustomerGrossSalesRow.localTextPrefix; };
        ...
        var TreeGrid = (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                _this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: FruitCorrect.Northwind.OrderRow.Fields.CustomerCompanyName,
...
(function (FruitCorrect) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return FruitCorrect.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return FruitCorrect.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return FruitCorrect.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
